<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('img/logo_circle.png') }}" alt="" class="block h-10 w-auto rounded-full">
                ...
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <x-dropdown-link :href="route('change_pwd')">
                                {{ __('變更密碼') }}
                            </x-dropdown-link>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="'/faq'" :active="request()->is('faq*')">
                {{ __('FAQ') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="'/teach_item'" :active="request()->is('teach_item*')">
                {{ __('創業教學項目') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="'/teach_pic'" :active="request()->is('teach_pic*')">
                {{ __('創業教學花絮') }}
            </x-responsive-nav-link>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                ...
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <x-responsive-nav-link :href="route('change_pwd')">
                        {{ __('變更密碼') }}
                    </x-responsive-nav-link>
