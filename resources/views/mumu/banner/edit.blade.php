    ...
    <section id="back_area" class="py-5">
        <div class="container my_con">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <p class="h3 fw-bold mb-0">Banner-編輯</p>
            </div>

            <form class="d-flex flex-column" action="/banner/update/{{ $myedit->id }}" method="post"
                enctype="multipart/form-data">
                @csrf
                <div class="mb-3 d-flex flex-column">
                    <p class="mb-0">現在的圖片</p>
                    <img id="blah" src="{{ asset($myedit->img) }}" alt="your image" />
                    <label for="banner_img" class="form-label mt-3">BANNER圖片上傳</label>
